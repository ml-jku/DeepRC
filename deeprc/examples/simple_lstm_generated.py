...
import argparse
from deeprc.deeprc_binary.predefined_datasets import lstm_generated_dataset
...
trainingset, trainingset_eval, validationset_eval, testset_eval = lstm_generated_dataset(dataset_id=args.id)
...
train(model, trainingset_dataloader=trainingset, trainingset_eval_dataloader=trainingset_eval,
      ...
      results_directory="results/simple_lstm_generated")
